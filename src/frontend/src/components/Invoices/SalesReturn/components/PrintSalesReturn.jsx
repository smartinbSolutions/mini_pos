...
export default function PrintSalesReturn() {
  ...
  useEffect(() => {
    let cancelled = false;
    Promise.all([
      window.api.getSalesReturnById(id),
      ...
      <div className="rounded border border-[#E5E5E2] p-4 mb-4">
        <div className="flex justify-between gap-6">
          <div className="w-1/2">
            ...
            <p className="font-medium">{returnInvoice.customer_name}</p>
            <p className="text-[#6B6F76]">{returnInvoice.customer_phone}</p>
          </div>
