        ...
        <div className="flex items-center justify-between print:hidden">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex h-9 items-center gap-1.5 rounded-xl bg-rose-500 px-3.5 text-sm font-bold text-white shadow-md shadow-rose-500/25 transition hover:bg-rose-600 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <Download size={14} />
        ...
        <div className="overflow-hidden rounded-2xl border border-[#e9edfb] bg-white shadow-[0_12px_40px_rgba(70,99,255,0.10)] print:rounded-none print:border-none print:shadow-none">
          <div className="grid gap-4 border-b border-[#eef1ff] bg-[#f6f8fd] p-5 md:grid-cols-[1fr_auto]">
            <div className="flex items-center gap-3">
              <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-rose-500 text-white shadow-md shadow-rose-500/25">
                <Undo2 size={20} />
              </span>
              <div>
                ...
                <table className="w-full min-w-[720px] text-sm">
                  <thead className="bg-[#f8faff] text-[11px] font-bold uppercase tracking-wide text-slate-400">
                    <tr>
                      ...
                      <th className="p-3 text-center">{t("ui.returnQty")}</th>
                      <th className="p-3 text-center">{t("ui.returnPrice")}</th>
                      ...
                      items.map((item) => {
                        ...
                        return (
                          <tr key={item.id} className="align-top">
                            ...
                            <td className="p-3 text-center font-black tabular-nums text-rose-700">
                              {money(lineTotal)}
                            </td>
                          </tr>
                        );
